...
Comment.create! content: "I like this very much.", modu: Modu.find(1), user: User.find(2)
Comment.create! content: "I'm not really feeling this...", modu: Modu.find(1), user: User.find(3)
...
Comment.create! content: "Great work teacher!", modu: Modu.find(1), user: User.find(2)
Comment.create! content: "Where can I get more of this?", modu: Modu.find(1), user: User.find(3)
...
Comment.create! content: "Wait a minute, what's going on?", modu: Modu.find(1), user: User.find(2)
Modu.create! title: "XSS", content: "XSS allows for session hijacking and defacement of website.", course: Course.find(1)
Comment.create! content: "I'm completely lost :(", modu: Modu.find(1), user: User.find(3)
